...
In the `bin` folder there is the main executable file named `terrain_trees` that contains the whole library. For a complete list of the command line options refer the [wiki](https://github.com/UMDGeoVis/Terrain_Trees/wiki/Command-line-parameters) page.
...
For a detailed description of the input formats refer the [wiki](https://github.com/UMDGeoVis/Terrain_Trees/wiki/Supported-Input-Formats) page.
